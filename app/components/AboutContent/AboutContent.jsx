...
export function AboutContent() {
  return (
    ...
    >
      <motion.p>
        Actuellement (encore) scientifique, je me suis formée à HTML et CSS il y
        a un certain nombre d’années. J&apos;ai pris plaisir à créer plusieurs
      ...
      <motion.p>
        Bientôt, je me lance en freelance pour créer des sites web et des outils
        interactifs. Mon but est de proposer des solutions web innovantes et
        efficaces, en combinant mes compétences techniques et ma passion pour le
        design.
      </motion.p>
